...
export function order251_1() {
  const allPokemons = findAllPokemons();
  const finalDown = allPokemons.sort(function (a, b) {//ordena los elementos del array y los trae ordenados del 251-1
    return b.num - a.num;
  });
  return finalDown;
}
...
export function getTotalAndAverange(pokemons, property) {
  //crea un nuevo arreglo con los resultados de la llamada a la funcion
